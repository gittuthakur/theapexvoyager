...
import ExpertHero from '@/components/modules/experts/ExpertHero';
    ...
    <DetailPageContainer>
      ...
      <div className="rounded-[2rem] border border-slate-200 bg-white p-10 shadow-glow">
        <div className="grid gap-8 xl:grid-cols-[1.4fr_0.9fr]">
            ...
            <aside className="h-fit space-y-6 rounded-[2rem] border border-slate-200 bg-slate-50 p-8 text-center xl:sticky xl:top-24 xl:self-start">
